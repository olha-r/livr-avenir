			...
			<div class="row mt-3">
				...
				<div class="row d-flex justify-content-center">
					<div class="col">
						<p class="author">
							<span
								v-for="(author, index) in book_details?.authorList"
								:key="index"
							>
								{{ author?.firstName }} {{ author?.lastName }}
								<span v-if="index < book_details?.authorList.length - 1"
									>,
								</span> </span
							><span class="text-muted fs-6">
								{{ t('client.bookDetailPage.bookDetail.author') }}</span
							>
						</p>
					</div>
				</div>
				...
				<div class="col book-info p-3">
					...
					<div class="row">
						<p>
							<span class="badge text-bg-warning px-3 category-badge me-1">{{
						...
						<div class="col">
							<p>
								<span class="fw-light"
									>{{ t('client.bookDetailPage.bookDetail.isbn') }} </span
						...
						<div class="col">
							<p>
								<span class="fw-light"
									>{{
										t('client.bookDetailPage.bookDetail.publicationYear')
									}} </span
					...
					<div class="row">
						<div class="col">
							<p>
								<span class="fw-light"
									>{{ t('client.bookDetailPage.bookDetail.publisher') }} </span
						...
						<div class="col">
							<p>
								<span class="fw-light">
									{{ t('client.bookDetailPage.bookDetail.pageCount') }} </span
					...
					<div class="row">
						<div class="col">
							<p>
								<span class="fw-light">
									{{ t('client.bookDetailPage.bookDetail.language') }}
								</span>
			...
			<span v-if="isLoggedIn">
				...
				<div v-else>
					<div class="row book-owner pt-3 mt-5 d-flex align-items-center">
						<div class="col-12">
							<p class="text-center">
								{{ t('client.bookDetailPage.bookItemDetail.noItems') }}
							</p>
						</div>
					</div>
				</div>
